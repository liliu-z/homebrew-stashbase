cask "stashbase" do
  version "1.3.1"
  sha256 "a4d464eb4eb45a40a30ba03b1a0fb8a14539eb697e8e518698769549802cb0f2"

  url "https://github.com/liliu-z/stashbase/releases/download/v1.3.1/StashBase-1.3.1-mac-arm64.dmg"
  name "StashBase"
